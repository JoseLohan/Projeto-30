...
var stones = [];
function preload() {
  zombie1 = loadAnimation('./assets/zombie1.png');
  zombie2 = loadAnimation('./assets/zombie2.png');
  zombie3 = loadAnimation('./assets/zombie3.png');
  zombie4 = loadAnimation('./assets/zombie4.png');
